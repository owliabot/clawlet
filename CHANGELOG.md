...
### Fixed
- Fix scrypt OOM: match eth-keystore default params (N=8192) to prevent out-of-memory kills on low-RAM machines (#48)

## [0.1.14] - 2026-02-09

### Changed
- Store mnemonic instead of raw private key in keystore (#46)
